...
{
    _ui.leUrl->setFullText("http://127.1:10000");
//    QString url = _ui.leUrl->fullText();
    QString url="http://127.0.0.1:10000";
    ...
    //validatePage();
    //emit wizard()->button(QWizard::NextButton)->clicked(true);
    //emit nextButton->clicked(true);
}
...
void OwncloudSetupPage::initializePage()
{
    ...
    _ui.leUrl->setFocus();
    _ui.leUrl->setText("http://127.1:10000");
